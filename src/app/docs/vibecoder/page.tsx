    ...
    <article className="space-y-6">
      ...
      <Callout tone="teal" title="Review these three things in whatever it writes">
        <ul className="mt-1 list-disc space-y-1.5 pl-5">
          <li>
            <span className="font-semibold text-[#111827]">The webhook reads raw bytes.</span> Look for{" "}
          ...
          <li>
            <span className="font-semibold text-[#111827]">The event id is claimed before fulfillment.</span> A
          ...
          <li>
            <span className="font-semibold text-[#111827]">No key reaches the client.</span> Grep the diff for{" "}
      ...
      <p className="max-w-3xl text-sm leading-relaxed text-black/70">
        ...
        <a href="/llms.txt" className="font-semibold text-[#2775CA] hover:underline">
          /llms.txt
        </a>{" "}
