    ...
    try {
        ...
        if (/^\d+$/.test(idParam)) {
            ...
            await createDmAndNotify({
                ...
                status: "APPROVED",
                title: "The merchant canceled this subscription",
                description: `The merchant set this subscription to end when your paid period runs out. Nothing more will be charged, and your access continues until then.`,
