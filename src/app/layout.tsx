    ...
    "@graph": [
        ...
        },
        {
            ...
            offers: {
                ...
                price: "0",
                priceCurrency: "USD",
                description: "Free to sign up. Merchants pay a transparent 1% processing fee on successful USDC payments. Customers pay no hidden maintenance or card fees.",
            },
            featureList: [
                "Continue with Google wallet onboarding",
                "USDC checkout and recurring payment routing on Arc Network",
                ...
                "Webhook delivery with HMAC signatures and event-sourced dispatch",
                "Webhook delivery attempt tracking with per-attempt HTTP status visibility",
                "Environment-isolated webhook endpoints (TEST/LIVE)",
                "Webhook secret rotation with grace-period overlap",
...
export const metadata: Metadata = {
    ...
    title: {
        default: "SubScript | Every way money moves for you and your business, settled in $USDC",
