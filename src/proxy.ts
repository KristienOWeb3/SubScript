...
function createContentSecurityPolicy(nonce: string) {
    ...
    return [
        ...
        "img-src 'self' data: blob: https://subscriptonarc.com https://www.subscriptonarc.com https://dashboard.subscriptonarc.com https://us.i.posthog.com https://us-assets.i.posthog.com https://explorer.arc.io https://explorer.arc.network https://explorer.testnet.arc.network https://jntqgoneegykgtiyvvge.supabase.co https://jkrlsjpsytzffwjpixue.supabase.co",
        "font-src 'self' data:",
        "connect-src 'self' https://challenges.cloudflare.com https://subscriptonarc.com https://www.subscriptonarc.com https://dashboard.subscriptonarc.com https://us.i.posthog.com https://us-assets.i.posthog.com https://*.ingest.us.sentry.io https://*.sentry.io https://auth.privy.io https://api.privy.io https://relay.walletconnect.com wss://relay.walletconnect.com https://api.circle.com https://iris-api.circle.com https://iris-api-sandbox.circle.com https://rpc.mainnet.arc.io https://rpc.testnet.arc.network https://rpc.mainnet.arc.network wss://ws.testnet.arc.network https://explorer.arc.io https://explorer.arc.network https://explorer.testnet.arc.network https://arcscan.app https://testnet.arcscan.app https://cloudflare-eth.com https://*.publicnode.com https://ethereum-rpc.publicnode.com https://ethereum-sepolia-rpc.publicnode.com https://arbitrum-sepolia-rpc.publicnode.com https://base-sepolia-rpc.publicnode.com https://optimism-rpc.publicnode.com https://polygon-bor-rpc.publicnode.com https://polygon-amoy-bor-rpc.publicnode.com https://base-rpc.publicnode.com https://arbitrum-one-rpc.publicnode.com https://*.arbitrum.io https://sepolia-rollup.arbitrum.io https://arb1.arbitrum.io https://*.base.org https://sepolia.base.org https://mainnet.base.org https://*.optimism.io https://sepolia.optimism.io https://mainnet.optimism.io https://*.polygon.technology https://rpc-amoy.polygon.technology https://polygon-rpc.com https://*.sepolia.org https://rpc.sepolia.org https://*.blockpi.network https://*.drpc.org https://*.avax.network https://api.avax-test.network https://api.avax.network https://rpc.ankr.com https://sepolia.gateway.tenderly.co https://1rpc.io https://5042.rpc.thirdweb.com https://5042002.rpc.thirdweb.com https://jntqgoneegykgtiyvvge.supabase.co https://jkrlsjpsytzffwjpixue.supabase.co",
