                    ...
                    >
                        ...
                        >
                            <div className="flex items-center justify-between px-6 py-4 border-b border-black/10">
                                <h2 id="deposit-usdc-title" className="text-sm font-bold uppercase tracking-wider text-[#082824]">Deposit USDC</h2>
                                <button
                                    onClick={resetAndClose}
                                    className="p-1.5 text-black/60 hover:text-black hover:bg-black/5 rounded-full transition-all"
                            ...
                            <div className="p-6 flex flex-col items-center font-sans">
                                ...
                                <div className="w-full px-4 py-3 bg-[#D4E3E8] border border-black/10 rounded-2xl mb-4 flex items-center justify-between">
                                    <div className="text-left">
                                        <p className="text-[9px] text-black/60 uppercase font-bold tracking-widest leading-none mb-1">
                                            Current Balance
                                        </p>
                                        <div className="flex items-baseline gap-1">
                                            <span className="text-base font-bold text-[#082824] tracking-tight">
                                                {usdcBalance}
                                            </span>
                                            <span className="text-[10px] text-black/60 font-semibold">USDC</span>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        ...
                                        <button
                                            ...
                                            className="p-1.5 text-[#082824] hover:bg-black/5 bg-white/70 rounded-lg transition-all flex items-center justify-center border border-black/10"
                                ...
                                {/* QR Code */}
                                <div className="p-3 bg-white border border-black/10 rounded-2xl inline-block mb-4 shadow-sm">
                                    <QRCode
                                ...
                                {/* Copy Address Box */}
                                <div className="w-full bg-white border border-black/15 rounded-2xl p-3">
                                    <p className="text-[9px] text-black/50 uppercase tracking-wider font-bold mb-1 text-left">
                                        Your Deposit Address
                                    </p>
                                    <div className="flex items-center gap-2">
                                        <code className="flex-1 text-[11px] text-black font-mono break-all text-left select-all">
                                            {depositAddress}
                                        </code>
                                        <button
                                            onClick={handleCopy}
                                            className="p-1.5 text-[#082824] hover:bg-black/5 rounded-lg transition-colors shrink-0"
                                            title="Copy address"
